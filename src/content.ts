  ...
  projects_section: {
    ...
    projects: [
      ...
      },
      {
        title: "ferie-monday",
        description:
          "Holiday overview pulling vacation data from Monday.com with Azure AD SSO, daily refresh, and admin CRUD.",
      },
      {
        title: "status-page",
        description:
          "Lightweight IT ops status page with live SSE updates, incident lifecycle management, and audit log.",
      },
      {
        title: "ms-admin-tools",
        description:
          "Browser-based admin console for Microsoft 365 — mailbox delegation, user on/offboarding, and account lifecycle.",
      },
    ],
  },
  skills: {
  ...
  snapshot: {
    ...
    items: [
      ...
      },
      {
        title: "How I Work",
        description:
          "Curious, practical, and a bit perfectionist. I like digging into details and fixing root causes, especially when a process is clunky and can be done better.",
      },
      {
        title: "Outside Work",
        description: "Music, gaming, travel, and PC building take up most of my free time.",
      },
      {
        title: "Community",
        description:
          "I used to volunteer in r/techsupport and enjoyed helping people solve technical issues from scratch.",
      },
    ],
  },
  contact: {
